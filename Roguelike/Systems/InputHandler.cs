...
namespace Roguelike {
    class InputHandler {
        ...
        /// <param name="Key"></param>
        /// <returns></returns>
        public bool ButtonHeld(Keys Key) {
        ...
        public bool MouseButtonPressed(MouseButton Button) {
            return MouseClickType(Button, this.ButtonPressed);
        }
        ...
        public bool MouseButtonHeld(MouseButton Button) {
            return MouseClickType(Button, this.ButtonHeld);
        }
        ...
        public bool MouseButtonReleased(MouseButton Button) {
            return MouseClickType(Button, this.ButtonReleased);
        }

        private bool MouseClickType(MouseButton Button, ButtonHandler ClickType) {
            switch (Button) {
        ...
        private bool ButtonPressed(ButtonState Current, ButtonState Previous) {
            return Current == ButtonState.Pressed && Previous == ButtonState.Released;
        }

        private bool ButtonHeld(ButtonState Current, ButtonState Previous) {
            return Current == ButtonState.Pressed && Previous == ButtonState.Released;
        }

        private bool ButtonReleased(ButtonState Current, ButtonState Previous) {
